...
{
    /// <summary>
    /// <see cref="TelemetryProperty"/> implementation to define the 'TrackTrace' method.
    /// </summary>
    public class TraceProperty : TelemetryProperty
    {
        ...
        {
            return new TraceTelemetry(Message, SeverityLevel);
        }
    }
}
