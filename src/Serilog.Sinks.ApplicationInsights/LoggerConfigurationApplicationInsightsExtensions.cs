...
namespace Serilog
{
    ...
    public static class LoggerConfigurationApplicationInsightsExtensions
    {
        ...
        /// <param name="logEventToTelemetryConverter">
        /// The <see cref="LogEvent" /> to <see cref="ITelemetry" /> converter.
        /// This will be called for every <see cref="LogEvent" /> and is expected to either return a new <see cref="ITelemetry" />
        /// instance that will be sent to AI
        /// or <see langword="null" /> to drop the log event completely.
        /// </param>
        ...
        /// <paramref name="instrumentationKey" /> cannot be empty or is
        /// <see langword="null" />.
        /// </exception>
            ...
            return
                loggerConfiguration.Sink(
                    new ApplicationInsightsSink(
                        CreateTelemetryClientFromInstrumentationkey(instrumentationKey),
            ...
            IFormatProvider formatProvider = null)
        {
            ...
            return
                loggerConfiguration.Sink(
                    new ApplicationInsightsSink(
                        CreateTelemetryClientFromConfiguration(telemetryConfiguration),
                        logEventToTelemetryConverter,
                        formatProvider),
                    restrictedToMinimumLevel);
        }
        ...
        /// <summary>
        /// Adds a Serilog sink that writes <see cref="LogEvent">log events</see> to Microsoft Application Insights as
        /// <see cref="EventTelemetry" />.
        /// </summary>
        /// <param name="loggerConfiguration">The logger configuration.</param>
        /// <param name="instrumentationKey">Required Application Insights instrumentation key.</param>
        /// <param name="restrictedToMinimumLevel">The minimum log event level required in order to write an event to the sink.</param>
        ...
        [Obsolete(
            "This unspecific AI Telemetry Sink will be removed once Serilog Core reaches v2.0, please use either .ApplicationInsightsEvents(..) or .ApplicationInsightsTraces(..)"
        )]
        public static LoggerConfiguration ApplicationInsights(
            this LoggerSinkConfiguration loggerConfiguration,
            string instrumentationKey,
        ...
        /// <param name="logEventToTelemetryConverter">
        /// The <see cref="LogEvent" /> to <see cref="ITelemetry" /> converter.
        /// If none is provided, the Serilog LogEvents will be sent as AI Events including all Properties.
        /// </param>
        /// <returns>
        /// Logger configuration, allowing configuration to continue.
        /// </returns>
            ...
            Func<LogEvent, IFormatProvider, IEnumerable<ITelemetry>> logEventToTelemetryConverter = null)
        {
            ...
            return
                loggerConfiguration.Sink(
                    new ApplicationInsightsEventsSink(
                        CreateTelemetryClientFromInstrumentationkey(instrumentationKey),
                        formatProvider,
                        logEventToTelemetryConverter),
                    restrictedToMinimumLevel);
        ...
        /// <param name="logEventToTelemetryConverter">
        /// The <see cref="LogEvent" /> to <see cref="ITelemetry" /> converter.
        /// If none is provided, the Serilog LogEvents will be sent as AI Traces including all Properties.
        /// </param>
        /// <returns>
        /// Logger configuration, allowing configuration to continue.
        /// </returns>
            ...
            Func<LogEvent, IFormatProvider, IEnumerable<ITelemetry>> logEventToTelemetryConverter = null)
        {
            ...
            return
                loggerConfiguration.Sink(
                    new ApplicationInsightsTracesSink(
                        CreateTelemetryClientFromInstrumentationkey(instrumentationKey),
                        formatProvider,
                        logEventToTelemetryConverter),
                    restrictedToMinimumLevel);
        ...
        /// <exception cref="System.ArgumentNullException">loggerConfiguration</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">instrumentationKey;Cannot be empty or null.</exception>
        public static LoggerConfiguration DynamicApplicationInsights(
            this LoggerSinkConfiguration loggerConfiguration,
            string instrumentationKey,
            LogEventLevel restrictedToMinimumLevel = LevelAlias.Minimum,
            IFormatProvider formatProvider = null)
        {
            ...
            return
                loggerConfiguration.Sink(
                    new DynamicApplicationInsightsSink(CreateTelemetryClientFromInstrumentationkey(instrumentationKey), formatProvider),
                    restrictedToMinimumLevel);
        }
        ...
        private static TelemetryClient CreateTelemetryClientFromInstrumentationkey(string instrumentationKey = "")
        {
            ...
            if (string.IsNullOrWhiteSpace(instrumentationKey) == false) telemetryClient.InstrumentationKey = instrumentationKey;
        ...
        /// <returns>
        /// A new <see cref="TelemetryClient" /> if a <paramref name="telemetryConfiguration" /> was provided, otherwise
        /// the <see cref="TelemetryConfiguration.Active" />.
        /// </returns>
